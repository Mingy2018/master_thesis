...
LOCAL_PATH = '/home/team1/cwu/tf-3dgan/data/3DShapeNets/volumetric_data/'
SERVER_PATH = '/home/team1/cwu/tf-3dgan/visdom_server/'
...
def getVFByMarchingCubes(voxels, threshold=0.5):
    ...
    v, f, normals, values =  sk.marching_cubes_lewiner(voxels, level=threshold)
    return v, f
